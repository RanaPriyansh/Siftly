...
Repository: https://github.com/RanaPriyansh/Siftly.git
Canonical local path: /root/Siftly
Default branch: main
...
## Priority tasks
1. Clarify the narrow wedge: what exact user/job this repo wins first, and cut dead features.
2. Make the demo path embarrassingly easy: one command, one sample input, one visible output.
3. Run the local setup path for Siftly and write exact commands back into README if they are missing or stale.
